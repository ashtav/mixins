...
class MixinsFormatter {
  static TextInputFormatter get numberOnly => FilteringTextInputFormatter.allow(RegExp("[0-9]"));
  static TextInputFormatter get lettersOnly => FilteringTextInputFormatter.allow(RegExp("[a-zA-Z ]"));
  static TextInputFormatter get lettersAndNumberOnly => FilteringTextInputFormatter.allow(RegExp("[a-zA-Z0-9 ]"));
